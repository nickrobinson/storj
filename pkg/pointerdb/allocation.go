...
func (allocation *AllocationSigner) PayerBandwidthAllocation(ctx context.Context, peerIdentity *identity.PeerIdentity, action pb.BandwidthAction, maxSize int64) (pba *pb.PayerBandwidthAllocation, err error) {
	if peerIdentity == nil {
