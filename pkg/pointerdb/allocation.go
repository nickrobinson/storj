...
func (allocation *AllocationSigner) PayerBandwidthAllocation(ctx context.Context, peerIdentity *identity.PeerIdentity, action pb.BandwidthAction, storageNodeIds []storj.NodeID) (pba *pb.PayerBandwidthAllocation, err error) {
	if peerIdentity == nil {
